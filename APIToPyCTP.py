...
codetree = {}
codetree.update(structtrue('../v6.3.6_20150515_traderapi_win64/ThostFtdcUserApiDataType.h'))
codetree.update(structtrue('../v6.3.6_20150515_traderapi_win64/ThostFtdcUserApiStruct.h'))
