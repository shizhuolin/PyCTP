...
///查询最大报单数量请求
PyObject *CTP_THOST_FTDC_TRADER_API_ReqQryMaxOrderVolume(PyObject *self, PyObject *args);
...
///请求查询分类合约
PyObject *CTP_THOST_FTDC_TRADER_API_ReqQryClassifiedInstrument(PyObject *self, PyObject *args);
