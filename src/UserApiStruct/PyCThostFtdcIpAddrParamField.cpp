...
static int PyCThostFtdcIpAddrParamField_init(PyCThostFtdcIpAddrParamField *self, PyObject *args, PyObject *kwds) {
    ...
    ///系统名称
    // TThostFtdcAddrNameType char[65]
    const char *IpAddrParamField_SysName = NULL;
    Py_ssize_t IpAddrParamField_SysName_len = 0;
            

#if PY_MAJOR_VERSION >= 3
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|y#y#iy#cciy#iiy#y#y#y#", (char **)kwlist
#else
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#is#ccis#iis#s#s#s#", (char **)kwlist
#endif
        ...
        , &IpAddrParamField_SysName, &IpAddrParamField_SysName_len 
    ...
    ///系统名称
    // TThostFtdcAddrNameType char[65]
    if( IpAddrParamField_SysName != NULL ) {
        if(IpAddrParamField_SysName_len >= (Py_ssize_t)sizeof(self->data.SysName)) {
            PyErr_Format(PyExc_ValueError, "SysName too long: length=%zd (max allowed is %zd)", IpAddrParamField_SysName_len, (Py_ssize_t)sizeof(self->data.SysName));
            return -1;
        }
        // memset(self->data.SysName, 0, sizeof(self->data.SysName));
        // memcpy(self->data.SysName, IpAddrParamField_SysName, IpAddrParamField_SysName_len);        
        strncpy(self->data.SysName, IpAddrParamField_SysName, sizeof(self->data.SysName) );
        IpAddrParamField_SysName = NULL;
    }
...
#if PY_MAJOR_VERSION >= 3
	PyObject *obj = Py_BuildValue("{s:y,s:y,s:i,s:y,s:c,s:c,s:i,s:y,s:i,s:i,s:y,s:y,s:y,s:y}"
#else
    PyObject *obj = Py_BuildValue("{s:s,s:s,s:i,s:s,s:c,s:c,s:i,s:s,s:i,s:i,s:s,s:s,s:s,s:s}"
#endif
        ...
        ,"SysName", self->data.SysName//, (Py_ssize_t)sizeof(self->data.SysName) 
...
///系统名称
// TThostFtdcAddrNameType char[65]
static PyObject *PyCThostFtdcIpAddrParamField_get_SysName(PyCThostFtdcIpAddrParamField *self, void *closure) {
    //return PyBytes_FromStringAndSize(self->data.SysName, (Py_ssize_t)sizeof(self->data.SysName));
    return PyBytes_FromString(self->data.SysName);
}

///系统名称
// TThostFtdcAddrNameType char[65]
static int PyCThostFtdcIpAddrParamField_set_SysName(PyCThostFtdcIpAddrParamField *self, PyObject* val, void *closure) {
    if (!PyBytes_Check(val)) {
    ...
    // memset(self->data.SysName, 0, sizeof(self->data.SysName));
    // memcpy(self->data.SysName, buf, len);
    strncpy(self->data.SysName, buf, sizeof(self->data.SysName));
    return 0;
}
...
static PyGetSetDef PyCThostFtdcIpAddrParamField_getset[] = {
    ...
    ///系统名称 
    {(char *)"SysName", (getter)PyCThostFtdcIpAddrParamField_get_SysName, (setter)PyCThostFtdcIpAddrParamField_set_SysName, (char *)"SysName", NULL},
