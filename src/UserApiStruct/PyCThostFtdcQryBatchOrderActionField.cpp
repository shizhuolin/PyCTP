...
static int PyCThostFtdcQryBatchOrderActionField_init(PyCThostFtdcQryBatchOrderActionField *self, PyObject *args, PyObject *kwds) {
    ...
    const char *QryBatchOrderActionField_BrokerID = NULL;
    Py_ssize_t QryBatchOrderActionField_BrokerID_len = 0;
            
    ///投资者代码
    // TThostFtdcInvestorIDType char[13]
    const char *QryBatchOrderActionField_InvestorID = NULL;
    Py_ssize_t QryBatchOrderActionField_InvestorID_len = 0;
            
    ///交易所代码
    // TThostFtdcExchangeIDType char[9]
    const char *QryBatchOrderActionField_ExchangeID = NULL;
    Py_ssize_t QryBatchOrderActionField_ExchangeID_len = 0;
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#s#", (char **)kwlist
        ...
        , &QryBatchOrderActionField_BrokerID, &QryBatchOrderActionField_BrokerID_len 
        , &QryBatchOrderActionField_InvestorID, &QryBatchOrderActionField_InvestorID_len 
        , &QryBatchOrderActionField_ExchangeID, &QryBatchOrderActionField_ExchangeID_len 
    ...
    ///经纪公司代码
    // TThostFtdcBrokerIDType char[11]
    if( QryBatchOrderActionField_BrokerID != NULL ) {
        if(QryBatchOrderActionField_BrokerID_len > (Py_ssize_t)sizeof(self->data.BrokerID)) {
            PyErr_Format(PyExc_ValueError, "BrokerID too long: length=%zd (max allowed is %zd)", QryBatchOrderActionField_BrokerID_len, (Py_ssize_t)sizeof(self->data.BrokerID));
            return -1;
        }
        // memset(self->data.BrokerID, 0, sizeof(self->data.BrokerID));
        // memcpy(self->data.BrokerID, QryBatchOrderActionField_BrokerID, QryBatchOrderActionField_BrokerID_len);        
        strncpy(self->data.BrokerID, QryBatchOrderActionField_BrokerID, sizeof(self->data.BrokerID) );
        QryBatchOrderActionField_BrokerID = NULL;
    }
            
    ///投资者代码
    // TThostFtdcInvestorIDType char[13]
    if( QryBatchOrderActionField_InvestorID != NULL ) {
        if(QryBatchOrderActionField_InvestorID_len > (Py_ssize_t)sizeof(self->data.InvestorID)) {
            PyErr_Format(PyExc_ValueError, "InvestorID too long: length=%zd (max allowed is %zd)", QryBatchOrderActionField_InvestorID_len, (Py_ssize_t)sizeof(self->data.InvestorID));
            return -1;
        }
        // memset(self->data.InvestorID, 0, sizeof(self->data.InvestorID));
        // memcpy(self->data.InvestorID, QryBatchOrderActionField_InvestorID, QryBatchOrderActionField_InvestorID_len);        
        strncpy(self->data.InvestorID, QryBatchOrderActionField_InvestorID, sizeof(self->data.InvestorID) );
        QryBatchOrderActionField_InvestorID = NULL;
    }
            
    ///交易所代码
    // TThostFtdcExchangeIDType char[9]
    if( QryBatchOrderActionField_ExchangeID != NULL ) {
        if(QryBatchOrderActionField_ExchangeID_len > (Py_ssize_t)sizeof(self->data.ExchangeID)) {
            PyErr_Format(PyExc_ValueError, "ExchangeID too long: length=%zd (max allowed is %zd)", QryBatchOrderActionField_ExchangeID_len, (Py_ssize_t)sizeof(self->data.ExchangeID));
            return -1;
        }
        // memset(self->data.ExchangeID, 0, sizeof(self->data.ExchangeID));
        // memcpy(self->data.ExchangeID, QryBatchOrderActionField_ExchangeID, QryBatchOrderActionField_ExchangeID_len);        
        strncpy(self->data.ExchangeID, QryBatchOrderActionField_ExchangeID, sizeof(self->data.ExchangeID) );
        QryBatchOrderActionField_ExchangeID = NULL;
    }
