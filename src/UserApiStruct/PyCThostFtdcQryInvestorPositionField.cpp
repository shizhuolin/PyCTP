...
static int PyCThostFtdcQryInvestorPositionField_init(PyCThostFtdcQryInvestorPositionField *self, PyObject *args, PyObject *kwds) {
    ...
    const char *QryInvestorPositionField_BrokerID = NULL;
    Py_ssize_t QryInvestorPositionField_BrokerID_len = 0;
            
    ///投资者代码
    // TThostFtdcInvestorIDType char[13]
    const char *QryInvestorPositionField_InvestorID = NULL;
    Py_ssize_t QryInvestorPositionField_InvestorID_len = 0;
            
    ///保留的无效字段
    // TThostFtdcOldInstrumentIDType char[31]
    const char *QryInvestorPositionField_reserve1 = NULL;
    Py_ssize_t QryInvestorPositionField_reserve1_len = 0;
            
    ///交易所代码
    // TThostFtdcExchangeIDType char[9]
    const char *QryInvestorPositionField_ExchangeID = NULL;
    Py_ssize_t QryInvestorPositionField_ExchangeID_len = 0;
            
    ///投资单元代码
    // TThostFtdcInvestUnitIDType char[17]
    const char *QryInvestorPositionField_InvestUnitID = NULL;
    Py_ssize_t QryInvestorPositionField_InvestUnitID_len = 0;
            
    ///合约代码
    // TThostFtdcInstrumentIDType char[81]
    const char *QryInvestorPositionField_InstrumentID = NULL;
    Py_ssize_t QryInvestorPositionField_InstrumentID_len = 0;
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#s#s#s#s#", (char **)kwlist
        ...
        , &QryInvestorPositionField_BrokerID, &QryInvestorPositionField_BrokerID_len 
        , &QryInvestorPositionField_InvestorID, &QryInvestorPositionField_InvestorID_len 
        , &QryInvestorPositionField_reserve1, &QryInvestorPositionField_reserve1_len 
        , &QryInvestorPositionField_ExchangeID, &QryInvestorPositionField_ExchangeID_len 
        , &QryInvestorPositionField_InvestUnitID, &QryInvestorPositionField_InvestUnitID_len 
        , &QryInvestorPositionField_InstrumentID, &QryInvestorPositionField_InstrumentID_len 
    ...
    ///经纪公司代码
    // TThostFtdcBrokerIDType char[11]
    if( QryInvestorPositionField_BrokerID != NULL ) {
        if(QryInvestorPositionField_BrokerID_len > (Py_ssize_t)sizeof(self->data.BrokerID)) {
            PyErr_Format(PyExc_ValueError, "BrokerID too long: length=%zd (max allowed is %zd)", QryInvestorPositionField_BrokerID_len, (Py_ssize_t)sizeof(self->data.BrokerID));
            return -1;
        }
        // memset(self->data.BrokerID, 0, sizeof(self->data.BrokerID));
        // memcpy(self->data.BrokerID, QryInvestorPositionField_BrokerID, QryInvestorPositionField_BrokerID_len);        
        strncpy(self->data.BrokerID, QryInvestorPositionField_BrokerID, sizeof(self->data.BrokerID) );
        QryInvestorPositionField_BrokerID = NULL;
    }
            
    ///投资者代码
    // TThostFtdcInvestorIDType char[13]
    if( QryInvestorPositionField_InvestorID != NULL ) {
        if(QryInvestorPositionField_InvestorID_len > (Py_ssize_t)sizeof(self->data.InvestorID)) {
            PyErr_Format(PyExc_ValueError, "InvestorID too long: length=%zd (max allowed is %zd)", QryInvestorPositionField_InvestorID_len, (Py_ssize_t)sizeof(self->data.InvestorID));
            return -1;
        }
        // memset(self->data.InvestorID, 0, sizeof(self->data.InvestorID));
        // memcpy(self->data.InvestorID, QryInvestorPositionField_InvestorID, QryInvestorPositionField_InvestorID_len);        
        strncpy(self->data.InvestorID, QryInvestorPositionField_InvestorID, sizeof(self->data.InvestorID) );
        QryInvestorPositionField_InvestorID = NULL;
    }
            
    ///保留的无效字段
    // TThostFtdcOldInstrumentIDType char[31]
    if( QryInvestorPositionField_reserve1 != NULL ) {
        if(QryInvestorPositionField_reserve1_len > (Py_ssize_t)sizeof(self->data.reserve1)) {
            PyErr_Format(PyExc_ValueError, "reserve1 too long: length=%zd (max allowed is %zd)", QryInvestorPositionField_reserve1_len, (Py_ssize_t)sizeof(self->data.reserve1));
            return -1;
        }
        // memset(self->data.reserve1, 0, sizeof(self->data.reserve1));
        // memcpy(self->data.reserve1, QryInvestorPositionField_reserve1, QryInvestorPositionField_reserve1_len);        
        strncpy(self->data.reserve1, QryInvestorPositionField_reserve1, sizeof(self->data.reserve1) );
        QryInvestorPositionField_reserve1 = NULL;
    }
            
    ///交易所代码
    // TThostFtdcExchangeIDType char[9]
    if( QryInvestorPositionField_ExchangeID != NULL ) {
        if(QryInvestorPositionField_ExchangeID_len > (Py_ssize_t)sizeof(self->data.ExchangeID)) {
            PyErr_Format(PyExc_ValueError, "ExchangeID too long: length=%zd (max allowed is %zd)", QryInvestorPositionField_ExchangeID_len, (Py_ssize_t)sizeof(self->data.ExchangeID));
            return -1;
        }
        // memset(self->data.ExchangeID, 0, sizeof(self->data.ExchangeID));
        // memcpy(self->data.ExchangeID, QryInvestorPositionField_ExchangeID, QryInvestorPositionField_ExchangeID_len);        
        strncpy(self->data.ExchangeID, QryInvestorPositionField_ExchangeID, sizeof(self->data.ExchangeID) );
        QryInvestorPositionField_ExchangeID = NULL;
    }
            
    ///投资单元代码
    // TThostFtdcInvestUnitIDType char[17]
    if( QryInvestorPositionField_InvestUnitID != NULL ) {
        if(QryInvestorPositionField_InvestUnitID_len > (Py_ssize_t)sizeof(self->data.InvestUnitID)) {
            PyErr_Format(PyExc_ValueError, "InvestUnitID too long: length=%zd (max allowed is %zd)", QryInvestorPositionField_InvestUnitID_len, (Py_ssize_t)sizeof(self->data.InvestUnitID));
            return -1;
        }
        // memset(self->data.InvestUnitID, 0, sizeof(self->data.InvestUnitID));
        // memcpy(self->data.InvestUnitID, QryInvestorPositionField_InvestUnitID, QryInvestorPositionField_InvestUnitID_len);        
        strncpy(self->data.InvestUnitID, QryInvestorPositionField_InvestUnitID, sizeof(self->data.InvestUnitID) );
        QryInvestorPositionField_InvestUnitID = NULL;
    }
            
    ///合约代码
    // TThostFtdcInstrumentIDType char[81]
    if( QryInvestorPositionField_InstrumentID != NULL ) {
        if(QryInvestorPositionField_InstrumentID_len > (Py_ssize_t)sizeof(self->data.InstrumentID)) {
            PyErr_Format(PyExc_ValueError, "InstrumentID too long: length=%zd (max allowed is %zd)", QryInvestorPositionField_InstrumentID_len, (Py_ssize_t)sizeof(self->data.InstrumentID));
            return -1;
        }
        // memset(self->data.InstrumentID, 0, sizeof(self->data.InstrumentID));
        // memcpy(self->data.InstrumentID, QryInvestorPositionField_InstrumentID, QryInvestorPositionField_InstrumentID_len);        
        strncpy(self->data.InstrumentID, QryInvestorPositionField_InstrumentID, sizeof(self->data.InstrumentID) );
        QryInvestorPositionField_InstrumentID = NULL;
    }
