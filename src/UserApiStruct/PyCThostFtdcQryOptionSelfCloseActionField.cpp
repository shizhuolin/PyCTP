...
static int PyCThostFtdcQryOptionSelfCloseActionField_init(PyCThostFtdcQryOptionSelfCloseActionField *self, PyObject *args, PyObject *kwds) {
    ...
    const char *QryOptionSelfCloseActionField_BrokerID = NULL;
    Py_ssize_t QryOptionSelfCloseActionField_BrokerID_len = 0;
            
    ///投资者代码
    // TThostFtdcInvestorIDType char[13]
    const char *QryOptionSelfCloseActionField_InvestorID = NULL;
    Py_ssize_t QryOptionSelfCloseActionField_InvestorID_len = 0;
            
    ///交易所代码
    // TThostFtdcExchangeIDType char[9]
    const char *QryOptionSelfCloseActionField_ExchangeID = NULL;
    Py_ssize_t QryOptionSelfCloseActionField_ExchangeID_len = 0;
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#s#", (char **)kwlist
        ...
        , &QryOptionSelfCloseActionField_BrokerID, &QryOptionSelfCloseActionField_BrokerID_len 
        , &QryOptionSelfCloseActionField_InvestorID, &QryOptionSelfCloseActionField_InvestorID_len 
        , &QryOptionSelfCloseActionField_ExchangeID, &QryOptionSelfCloseActionField_ExchangeID_len 
    ...
    ///经纪公司代码
    // TThostFtdcBrokerIDType char[11]
    if( QryOptionSelfCloseActionField_BrokerID != NULL ) {
        if(QryOptionSelfCloseActionField_BrokerID_len > (Py_ssize_t)sizeof(self->data.BrokerID)) {
            PyErr_Format(PyExc_ValueError, "BrokerID too long: length=%zd (max allowed is %zd)", QryOptionSelfCloseActionField_BrokerID_len, (Py_ssize_t)sizeof(self->data.BrokerID));
            return -1;
        }
        // memset(self->data.BrokerID, 0, sizeof(self->data.BrokerID));
        // memcpy(self->data.BrokerID, QryOptionSelfCloseActionField_BrokerID, QryOptionSelfCloseActionField_BrokerID_len);        
        strncpy(self->data.BrokerID, QryOptionSelfCloseActionField_BrokerID, sizeof(self->data.BrokerID) );
        QryOptionSelfCloseActionField_BrokerID = NULL;
    }
            
    ///投资者代码
    // TThostFtdcInvestorIDType char[13]
    if( QryOptionSelfCloseActionField_InvestorID != NULL ) {
        if(QryOptionSelfCloseActionField_InvestorID_len > (Py_ssize_t)sizeof(self->data.InvestorID)) {
            PyErr_Format(PyExc_ValueError, "InvestorID too long: length=%zd (max allowed is %zd)", QryOptionSelfCloseActionField_InvestorID_len, (Py_ssize_t)sizeof(self->data.InvestorID));
            return -1;
        }
        // memset(self->data.InvestorID, 0, sizeof(self->data.InvestorID));
        // memcpy(self->data.InvestorID, QryOptionSelfCloseActionField_InvestorID, QryOptionSelfCloseActionField_InvestorID_len);        
        strncpy(self->data.InvestorID, QryOptionSelfCloseActionField_InvestorID, sizeof(self->data.InvestorID) );
        QryOptionSelfCloseActionField_InvestorID = NULL;
    }
            
    ///交易所代码
    // TThostFtdcExchangeIDType char[9]
    if( QryOptionSelfCloseActionField_ExchangeID != NULL ) {
        if(QryOptionSelfCloseActionField_ExchangeID_len > (Py_ssize_t)sizeof(self->data.ExchangeID)) {
            PyErr_Format(PyExc_ValueError, "ExchangeID too long: length=%zd (max allowed is %zd)", QryOptionSelfCloseActionField_ExchangeID_len, (Py_ssize_t)sizeof(self->data.ExchangeID));
            return -1;
        }
        // memset(self->data.ExchangeID, 0, sizeof(self->data.ExchangeID));
        // memcpy(self->data.ExchangeID, QryOptionSelfCloseActionField_ExchangeID, QryOptionSelfCloseActionField_ExchangeID_len);        
        strncpy(self->data.ExchangeID, QryOptionSelfCloseActionField_ExchangeID, sizeof(self->data.ExchangeID) );
        QryOptionSelfCloseActionField_ExchangeID = NULL;
    }
