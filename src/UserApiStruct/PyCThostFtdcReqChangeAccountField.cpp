...
static int PyCThostFtdcReqChangeAccountField_init(PyCThostFtdcReqChangeAccountField *self, PyObject *args, PyObject *kwds) {
    ...
    const char *ReqChangeAccountField_TradeCode = NULL;
    Py_ssize_t ReqChangeAccountField_TradeCode_len = 0;
            
    ///银行代码
    // TThostFtdcBankIDType char[4]
    const char *ReqChangeAccountField_BankID = NULL;
    Py_ssize_t ReqChangeAccountField_BankID_len = 0;
            
    ///银行分支机构代码
    // TThostFtdcBankBrchIDType char[5]
    const char *ReqChangeAccountField_BankBranchID = NULL;
    Py_ssize_t ReqChangeAccountField_BankBranchID_len = 0;
            
    ///期商代码
    // TThostFtdcBrokerIDType char[11]
    const char *ReqChangeAccountField_BrokerID = NULL;
    Py_ssize_t ReqChangeAccountField_BrokerID_len = 0;
            
    ///期商分支机构代码
    // TThostFtdcFutureBranchIDType char[31]
    const char *ReqChangeAccountField_BrokerBranchID = NULL;
    Py_ssize_t ReqChangeAccountField_BrokerBranchID_len = 0;
            
    ///交易日期
    // TThostFtdcTradeDateType char[9]
    const char *ReqChangeAccountField_TradeDate = NULL;
    Py_ssize_t ReqChangeAccountField_TradeDate_len = 0;
            
    ///交易时间
    // TThostFtdcTradeTimeType char[9]
    const char *ReqChangeAccountField_TradeTime = NULL;
    Py_ssize_t ReqChangeAccountField_TradeTime_len = 0;
            
    ///银行流水号
    // TThostFtdcBankSerialType char[13]
    const char *ReqChangeAccountField_BankSerial = NULL;
    Py_ssize_t ReqChangeAccountField_BankSerial_len = 0;
            
    ///交易系统日期
    // TThostFtdcTradeDateType char[9]
    const char *ReqChangeAccountField_TradingDay = NULL;
    Py_ssize_t ReqChangeAccountField_TradingDay_len = 0;
            
    ///银期平台消息流水号
    // TThostFtdcSerialType int
    int ReqChangeAccountField_PlateSerial = 0;
        
    ///最后分片标志
    // TThostFtdcLastFragmentType char
    char ReqChangeAccountField_LastFragment = 0;
            
    ///会话号
    // TThostFtdcSessionIDType int
    int ReqChangeAccountField_SessionID = 0;
        
    ///客户姓名
    // TThostFtdcIndividualNameType char[51]
    const char *ReqChangeAccountField_CustomerName = NULL;
    Py_ssize_t ReqChangeAccountField_CustomerName_len = 0;
            
    ///证件类型
    // TThostFtdcIdCardTypeType char
    char ReqChangeAccountField_IdCardType = 0;
            
    ///证件号码
    // TThostFtdcIdentifiedCardNoType char[51]
    const char *ReqChangeAccountField_IdentifiedCardNo = NULL;
    Py_ssize_t ReqChangeAccountField_IdentifiedCardNo_len = 0;
            
    ///性别
    // TThostFtdcGenderType char
    char ReqChangeAccountField_Gender = 0;
            
    ///国家代码
    // TThostFtdcCountryCodeType char[21]
    const char *ReqChangeAccountField_CountryCode = NULL;
    Py_ssize_t ReqChangeAccountField_CountryCode_len = 0;
            
    ///客户类型
    // TThostFtdcCustTypeType char
    char ReqChangeAccountField_CustType = 0;
            
    ///地址
    // TThostFtdcAddressType char[101]
    const char *ReqChangeAccountField_Address = NULL;
    Py_ssize_t ReqChangeAccountField_Address_len = 0;
            
    ///邮编
    // TThostFtdcZipCodeType char[7]
    const char *ReqChangeAccountField_ZipCode = NULL;
    Py_ssize_t ReqChangeAccountField_ZipCode_len = 0;
            
    ///电话号码
    // TThostFtdcTelephoneType char[41]
    const char *ReqChangeAccountField_Telephone = NULL;
    Py_ssize_t ReqChangeAccountField_Telephone_len = 0;
            
    ///手机
    // TThostFtdcMobilePhoneType char[21]
    const char *ReqChangeAccountField_MobilePhone = NULL;
    Py_ssize_t ReqChangeAccountField_MobilePhone_len = 0;
            
    ///传真
    // TThostFtdcFaxType char[41]
    const char *ReqChangeAccountField_Fax = NULL;
    Py_ssize_t ReqChangeAccountField_Fax_len = 0;
            
    ///电子邮件
    // TThostFtdcEMailType char[41]
    const char *ReqChangeAccountField_EMail = NULL;
    Py_ssize_t ReqChangeAccountField_EMail_len = 0;
            
    ///资金账户状态
    // TThostFtdcMoneyAccountStatusType char
    char ReqChangeAccountField_MoneyAccountStatus = 0;
            
    ///银行帐号
    // TThostFtdcBankAccountType char[41]
    const char *ReqChangeAccountField_BankAccount = NULL;
    Py_ssize_t ReqChangeAccountField_BankAccount_len = 0;
            
    ///银行密码
    // TThostFtdcPasswordType char[41]
    const char *ReqChangeAccountField_BankPassWord = NULL;
    Py_ssize_t ReqChangeAccountField_BankPassWord_len = 0;
            
    ///新银行帐号
    // TThostFtdcBankAccountType char[41]
    const char *ReqChangeAccountField_NewBankAccount = NULL;
    Py_ssize_t ReqChangeAccountField_NewBankAccount_len = 0;
            
    ///新银行密码
    // TThostFtdcPasswordType char[41]
    const char *ReqChangeAccountField_NewBankPassWord = NULL;
    Py_ssize_t ReqChangeAccountField_NewBankPassWord_len = 0;
            
    ///投资者帐号
    // TThostFtdcAccountIDType char[13]
    const char *ReqChangeAccountField_AccountID = NULL;
    Py_ssize_t ReqChangeAccountField_AccountID_len = 0;
            
    ///期货密码
    // TThostFtdcPasswordType char[41]
    const char *ReqChangeAccountField_Password = NULL;
    Py_ssize_t ReqChangeAccountField_Password_len = 0;
            
    ///银行帐号类型
    // TThostFtdcBankAccTypeType char
    char ReqChangeAccountField_BankAccType = 0;
            
    ///安装编号
    // TThostFtdcInstallIDType int
    int ReqChangeAccountField_InstallID = 0;
        
    ///验证客户证件号码标志
    // TThostFtdcYesNoIndicatorType char
    char ReqChangeAccountField_VerifyCertNoFlag = 0;
            
    ///币种代码
    // TThostFtdcCurrencyIDType char[4]
    const char *ReqChangeAccountField_CurrencyID = NULL;
    Py_ssize_t ReqChangeAccountField_CurrencyID_len = 0;
            
    ///期货公司银行编码
    // TThostFtdcBankCodingForFutureType char[33]
    const char *ReqChangeAccountField_BrokerIDByBank = NULL;
    Py_ssize_t ReqChangeAccountField_BrokerIDByBank_len = 0;
            
    ///银行密码标志
    // TThostFtdcPwdFlagType char
    char ReqChangeAccountField_BankPwdFlag = 0;
            
    ///期货资金密码核对标志
    // TThostFtdcPwdFlagType char
    char ReqChangeAccountField_SecuPwdFlag = 0;
            
    ///交易ID
    // TThostFtdcTIDType int
    int ReqChangeAccountField_TID = 0;
        
    ///摘要
    // TThostFtdcDigestType char[36]
    const char *ReqChangeAccountField_Digest = NULL;
    Py_ssize_t ReqChangeAccountField_Digest_len = 0;
            
    ///长客户姓名
    // TThostFtdcLongIndividualNameType char[161]
    const char *ReqChangeAccountField_LongCustomerName = NULL;
    Py_ssize_t ReqChangeAccountField_LongCustomerName_len = 0;
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#s#s#s#s#s#s#s#icis#cs#cs#cs#s#s#s#s#s#cs#s#s#s#s#s#cics#s#ccis#s#", (char **)kwlist
        ...
        , &ReqChangeAccountField_TradeCode, &ReqChangeAccountField_TradeCode_len 
        , &ReqChangeAccountField_BankID, &ReqChangeAccountField_BankID_len 
        , &ReqChangeAccountField_BankBranchID, &ReqChangeAccountField_BankBranchID_len 
        , &ReqChangeAccountField_BrokerID, &ReqChangeAccountField_BrokerID_len 
        , &ReqChangeAccountField_BrokerBranchID, &ReqChangeAccountField_BrokerBranchID_len 
        , &ReqChangeAccountField_TradeDate, &ReqChangeAccountField_TradeDate_len 
        , &ReqChangeAccountField_TradeTime, &ReqChangeAccountField_TradeTime_len 
        , &ReqChangeAccountField_BankSerial, &ReqChangeAccountField_BankSerial_len 
        , &ReqChangeAccountField_TradingDay, &ReqChangeAccountField_TradingDay_len 
        , &ReqChangeAccountField_PlateSerial 
        , &ReqChangeAccountField_LastFragment 
        , &ReqChangeAccountField_SessionID 
        , &ReqChangeAccountField_CustomerName, &ReqChangeAccountField_CustomerName_len 
        , &ReqChangeAccountField_IdCardType 
        , &ReqChangeAccountField_IdentifiedCardNo, &ReqChangeAccountField_IdentifiedCardNo_len 
        , &ReqChangeAccountField_Gender 
        , &ReqChangeAccountField_CountryCode, &ReqChangeAccountField_CountryCode_len 
        , &ReqChangeAccountField_CustType 
        , &ReqChangeAccountField_Address, &ReqChangeAccountField_Address_len 
        , &ReqChangeAccountField_ZipCode, &ReqChangeAccountField_ZipCode_len 
        , &ReqChangeAccountField_Telephone, &ReqChangeAccountField_Telephone_len 
        , &ReqChangeAccountField_MobilePhone, &ReqChangeAccountField_MobilePhone_len 
        , &ReqChangeAccountField_Fax, &ReqChangeAccountField_Fax_len 
        , &ReqChangeAccountField_EMail, &ReqChangeAccountField_EMail_len 
        , &ReqChangeAccountField_MoneyAccountStatus 
        , &ReqChangeAccountField_BankAccount, &ReqChangeAccountField_BankAccount_len 
        , &ReqChangeAccountField_BankPassWord, &ReqChangeAccountField_BankPassWord_len 
        , &ReqChangeAccountField_NewBankAccount, &ReqChangeAccountField_NewBankAccount_len 
        , &ReqChangeAccountField_NewBankPassWord, &ReqChangeAccountField_NewBankPassWord_len 
        , &ReqChangeAccountField_AccountID, &ReqChangeAccountField_AccountID_len 
        , &ReqChangeAccountField_Password, &ReqChangeAccountField_Password_len 
        , &ReqChangeAccountField_BankAccType 
        , &ReqChangeAccountField_InstallID 
        , &ReqChangeAccountField_VerifyCertNoFlag 
        , &ReqChangeAccountField_CurrencyID, &ReqChangeAccountField_CurrencyID_len 
        , &ReqChangeAccountField_BrokerIDByBank, &ReqChangeAccountField_BrokerIDByBank_len 
        , &ReqChangeAccountField_BankPwdFlag 
        , &ReqChangeAccountField_SecuPwdFlag 
        , &ReqChangeAccountField_TID 
        , &ReqChangeAccountField_Digest, &ReqChangeAccountField_Digest_len 
        , &ReqChangeAccountField_LongCustomerName, &ReqChangeAccountField_LongCustomerName_len 
    ...
    ///业务功能码
    // TThostFtdcTradeCodeType char[7]
    if( ReqChangeAccountField_TradeCode != NULL ) {
        if(ReqChangeAccountField_TradeCode_len > (Py_ssize_t)sizeof(self->data.TradeCode)) {
            PyErr_Format(PyExc_ValueError, "TradeCode too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_TradeCode_len, (Py_ssize_t)sizeof(self->data.TradeCode));
            return -1;
        }
        // memset(self->data.TradeCode, 0, sizeof(self->data.TradeCode));
        // memcpy(self->data.TradeCode, ReqChangeAccountField_TradeCode, ReqChangeAccountField_TradeCode_len);        
        strncpy(self->data.TradeCode, ReqChangeAccountField_TradeCode, sizeof(self->data.TradeCode) );
        ReqChangeAccountField_TradeCode = NULL;
    }
            
    ///银行代码
    // TThostFtdcBankIDType char[4]
    if( ReqChangeAccountField_BankID != NULL ) {
        if(ReqChangeAccountField_BankID_len > (Py_ssize_t)sizeof(self->data.BankID)) {
            PyErr_Format(PyExc_ValueError, "BankID too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_BankID_len, (Py_ssize_t)sizeof(self->data.BankID));
            return -1;
        }
        // memset(self->data.BankID, 0, sizeof(self->data.BankID));
        // memcpy(self->data.BankID, ReqChangeAccountField_BankID, ReqChangeAccountField_BankID_len);        
        strncpy(self->data.BankID, ReqChangeAccountField_BankID, sizeof(self->data.BankID) );
        ReqChangeAccountField_BankID = NULL;
    }
            
    ///银行分支机构代码
    // TThostFtdcBankBrchIDType char[5]
    if( ReqChangeAccountField_BankBranchID != NULL ) {
        if(ReqChangeAccountField_BankBranchID_len > (Py_ssize_t)sizeof(self->data.BankBranchID)) {
            PyErr_Format(PyExc_ValueError, "BankBranchID too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_BankBranchID_len, (Py_ssize_t)sizeof(self->data.BankBranchID));
            return -1;
        }
        // memset(self->data.BankBranchID, 0, sizeof(self->data.BankBranchID));
        // memcpy(self->data.BankBranchID, ReqChangeAccountField_BankBranchID, ReqChangeAccountField_BankBranchID_len);        
        strncpy(self->data.BankBranchID, ReqChangeAccountField_BankBranchID, sizeof(self->data.BankBranchID) );
        ReqChangeAccountField_BankBranchID = NULL;
    }
            
    ///期商代码
    // TThostFtdcBrokerIDType char[11]
    if( ReqChangeAccountField_BrokerID != NULL ) {
        if(ReqChangeAccountField_BrokerID_len > (Py_ssize_t)sizeof(self->data.BrokerID)) {
            PyErr_Format(PyExc_ValueError, "BrokerID too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_BrokerID_len, (Py_ssize_t)sizeof(self->data.BrokerID));
            return -1;
        }
        // memset(self->data.BrokerID, 0, sizeof(self->data.BrokerID));
        // memcpy(self->data.BrokerID, ReqChangeAccountField_BrokerID, ReqChangeAccountField_BrokerID_len);        
        strncpy(self->data.BrokerID, ReqChangeAccountField_BrokerID, sizeof(self->data.BrokerID) );
        ReqChangeAccountField_BrokerID = NULL;
    }
            
    ///期商分支机构代码
    // TThostFtdcFutureBranchIDType char[31]
    if( ReqChangeAccountField_BrokerBranchID != NULL ) {
        if(ReqChangeAccountField_BrokerBranchID_len > (Py_ssize_t)sizeof(self->data.BrokerBranchID)) {
            PyErr_Format(PyExc_ValueError, "BrokerBranchID too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_BrokerBranchID_len, (Py_ssize_t)sizeof(self->data.BrokerBranchID));
            return -1;
        }
        // memset(self->data.BrokerBranchID, 0, sizeof(self->data.BrokerBranchID));
        // memcpy(self->data.BrokerBranchID, ReqChangeAccountField_BrokerBranchID, ReqChangeAccountField_BrokerBranchID_len);        
        strncpy(self->data.BrokerBranchID, ReqChangeAccountField_BrokerBranchID, sizeof(self->data.BrokerBranchID) );
        ReqChangeAccountField_BrokerBranchID = NULL;
    }
            
    ///交易日期
    // TThostFtdcTradeDateType char[9]
    if( ReqChangeAccountField_TradeDate != NULL ) {
        if(ReqChangeAccountField_TradeDate_len > (Py_ssize_t)sizeof(self->data.TradeDate)) {
            PyErr_Format(PyExc_ValueError, "TradeDate too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_TradeDate_len, (Py_ssize_t)sizeof(self->data.TradeDate));
            return -1;
        }
        // memset(self->data.TradeDate, 0, sizeof(self->data.TradeDate));
        // memcpy(self->data.TradeDate, ReqChangeAccountField_TradeDate, ReqChangeAccountField_TradeDate_len);        
        strncpy(self->data.TradeDate, ReqChangeAccountField_TradeDate, sizeof(self->data.TradeDate) );
        ReqChangeAccountField_TradeDate = NULL;
    }
            
    ///交易时间
    // TThostFtdcTradeTimeType char[9]
    if( ReqChangeAccountField_TradeTime != NULL ) {
        if(ReqChangeAccountField_TradeTime_len > (Py_ssize_t)sizeof(self->data.TradeTime)) {
            PyErr_Format(PyExc_ValueError, "TradeTime too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_TradeTime_len, (Py_ssize_t)sizeof(self->data.TradeTime));
            return -1;
        }
        // memset(self->data.TradeTime, 0, sizeof(self->data.TradeTime));
        // memcpy(self->data.TradeTime, ReqChangeAccountField_TradeTime, ReqChangeAccountField_TradeTime_len);        
        strncpy(self->data.TradeTime, ReqChangeAccountField_TradeTime, sizeof(self->data.TradeTime) );
        ReqChangeAccountField_TradeTime = NULL;
    }
            
    ///银行流水号
    // TThostFtdcBankSerialType char[13]
    if( ReqChangeAccountField_BankSerial != NULL ) {
        if(ReqChangeAccountField_BankSerial_len > (Py_ssize_t)sizeof(self->data.BankSerial)) {
            PyErr_Format(PyExc_ValueError, "BankSerial too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_BankSerial_len, (Py_ssize_t)sizeof(self->data.BankSerial));
            return -1;
        }
        // memset(self->data.BankSerial, 0, sizeof(self->data.BankSerial));
        // memcpy(self->data.BankSerial, ReqChangeAccountField_BankSerial, ReqChangeAccountField_BankSerial_len);        
        strncpy(self->data.BankSerial, ReqChangeAccountField_BankSerial, sizeof(self->data.BankSerial) );
        ReqChangeAccountField_BankSerial = NULL;
    }
            
    ///交易系统日期
    // TThostFtdcTradeDateType char[9]
    if( ReqChangeAccountField_TradingDay != NULL ) {
        if(ReqChangeAccountField_TradingDay_len > (Py_ssize_t)sizeof(self->data.TradingDay)) {
            PyErr_Format(PyExc_ValueError, "TradingDay too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_TradingDay_len, (Py_ssize_t)sizeof(self->data.TradingDay));
            return -1;
        }
        // memset(self->data.TradingDay, 0, sizeof(self->data.TradingDay));
        // memcpy(self->data.TradingDay, ReqChangeAccountField_TradingDay, ReqChangeAccountField_TradingDay_len);        
        strncpy(self->data.TradingDay, ReqChangeAccountField_TradingDay, sizeof(self->data.TradingDay) );
        ReqChangeAccountField_TradingDay = NULL;
    }
            
    ///银期平台消息流水号
    // TThostFtdcSerialType int
    self->data.PlateSerial = ReqChangeAccountField_PlateSerial;
        
    ///最后分片标志
    // TThostFtdcLastFragmentType char
    self->data.LastFragment = ReqChangeAccountField_LastFragment;
            
    ///会话号
    // TThostFtdcSessionIDType int
    self->data.SessionID = ReqChangeAccountField_SessionID;
        
    ///客户姓名
    // TThostFtdcIndividualNameType char[51]
    if( ReqChangeAccountField_CustomerName != NULL ) {
        if(ReqChangeAccountField_CustomerName_len > (Py_ssize_t)sizeof(self->data.CustomerName)) {
            PyErr_Format(PyExc_ValueError, "CustomerName too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_CustomerName_len, (Py_ssize_t)sizeof(self->data.CustomerName));
            return -1;
        }
        // memset(self->data.CustomerName, 0, sizeof(self->data.CustomerName));
        // memcpy(self->data.CustomerName, ReqChangeAccountField_CustomerName, ReqChangeAccountField_CustomerName_len);        
        strncpy(self->data.CustomerName, ReqChangeAccountField_CustomerName, sizeof(self->data.CustomerName) );
        ReqChangeAccountField_CustomerName = NULL;
    }
            
    ///证件类型
    // TThostFtdcIdCardTypeType char
    self->data.IdCardType = ReqChangeAccountField_IdCardType;
            
    ///证件号码
    // TThostFtdcIdentifiedCardNoType char[51]
    if( ReqChangeAccountField_IdentifiedCardNo != NULL ) {
        if(ReqChangeAccountField_IdentifiedCardNo_len > (Py_ssize_t)sizeof(self->data.IdentifiedCardNo)) {
            PyErr_Format(PyExc_ValueError, "IdentifiedCardNo too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_IdentifiedCardNo_len, (Py_ssize_t)sizeof(self->data.IdentifiedCardNo));
            return -1;
        }
        // memset(self->data.IdentifiedCardNo, 0, sizeof(self->data.IdentifiedCardNo));
        // memcpy(self->data.IdentifiedCardNo, ReqChangeAccountField_IdentifiedCardNo, ReqChangeAccountField_IdentifiedCardNo_len);        
        strncpy(self->data.IdentifiedCardNo, ReqChangeAccountField_IdentifiedCardNo, sizeof(self->data.IdentifiedCardNo) );
        ReqChangeAccountField_IdentifiedCardNo = NULL;
    }
            
    ///性别
    // TThostFtdcGenderType char
    self->data.Gender = ReqChangeAccountField_Gender;
            
    ///国家代码
    // TThostFtdcCountryCodeType char[21]
    if( ReqChangeAccountField_CountryCode != NULL ) {
        if(ReqChangeAccountField_CountryCode_len > (Py_ssize_t)sizeof(self->data.CountryCode)) {
            PyErr_Format(PyExc_ValueError, "CountryCode too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_CountryCode_len, (Py_ssize_t)sizeof(self->data.CountryCode));
            return -1;
        }
        // memset(self->data.CountryCode, 0, sizeof(self->data.CountryCode));
        // memcpy(self->data.CountryCode, ReqChangeAccountField_CountryCode, ReqChangeAccountField_CountryCode_len);        
        strncpy(self->data.CountryCode, ReqChangeAccountField_CountryCode, sizeof(self->data.CountryCode) );
        ReqChangeAccountField_CountryCode = NULL;
    }
            
    ///客户类型
    // TThostFtdcCustTypeType char
    self->data.CustType = ReqChangeAccountField_CustType;
            
    ///地址
    // TThostFtdcAddressType char[101]
    if( ReqChangeAccountField_Address != NULL ) {
        if(ReqChangeAccountField_Address_len > (Py_ssize_t)sizeof(self->data.Address)) {
            PyErr_Format(PyExc_ValueError, "Address too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_Address_len, (Py_ssize_t)sizeof(self->data.Address));
            return -1;
        }
        // memset(self->data.Address, 0, sizeof(self->data.Address));
        // memcpy(self->data.Address, ReqChangeAccountField_Address, ReqChangeAccountField_Address_len);        
        strncpy(self->data.Address, ReqChangeAccountField_Address, sizeof(self->data.Address) );
        ReqChangeAccountField_Address = NULL;
    }
            
    ///邮编
    // TThostFtdcZipCodeType char[7]
    if( ReqChangeAccountField_ZipCode != NULL ) {
        if(ReqChangeAccountField_ZipCode_len > (Py_ssize_t)sizeof(self->data.ZipCode)) {
            PyErr_Format(PyExc_ValueError, "ZipCode too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_ZipCode_len, (Py_ssize_t)sizeof(self->data.ZipCode));
            return -1;
        }
        // memset(self->data.ZipCode, 0, sizeof(self->data.ZipCode));
        // memcpy(self->data.ZipCode, ReqChangeAccountField_ZipCode, ReqChangeAccountField_ZipCode_len);        
        strncpy(self->data.ZipCode, ReqChangeAccountField_ZipCode, sizeof(self->data.ZipCode) );
        ReqChangeAccountField_ZipCode = NULL;
    }
            
    ///电话号码
    // TThostFtdcTelephoneType char[41]
    if( ReqChangeAccountField_Telephone != NULL ) {
        if(ReqChangeAccountField_Telephone_len > (Py_ssize_t)sizeof(self->data.Telephone)) {
            PyErr_Format(PyExc_ValueError, "Telephone too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_Telephone_len, (Py_ssize_t)sizeof(self->data.Telephone));
            return -1;
        }
        // memset(self->data.Telephone, 0, sizeof(self->data.Telephone));
        // memcpy(self->data.Telephone, ReqChangeAccountField_Telephone, ReqChangeAccountField_Telephone_len);        
        strncpy(self->data.Telephone, ReqChangeAccountField_Telephone, sizeof(self->data.Telephone) );
        ReqChangeAccountField_Telephone = NULL;
    }
            
    ///手机
    // TThostFtdcMobilePhoneType char[21]
    if( ReqChangeAccountField_MobilePhone != NULL ) {
        if(ReqChangeAccountField_MobilePhone_len > (Py_ssize_t)sizeof(self->data.MobilePhone)) {
            PyErr_Format(PyExc_ValueError, "MobilePhone too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_MobilePhone_len, (Py_ssize_t)sizeof(self->data.MobilePhone));
            return -1;
        }
        // memset(self->data.MobilePhone, 0, sizeof(self->data.MobilePhone));
        // memcpy(self->data.MobilePhone, ReqChangeAccountField_MobilePhone, ReqChangeAccountField_MobilePhone_len);        
        strncpy(self->data.MobilePhone, ReqChangeAccountField_MobilePhone, sizeof(self->data.MobilePhone) );
        ReqChangeAccountField_MobilePhone = NULL;
    }
            
    ///传真
    // TThostFtdcFaxType char[41]
    if( ReqChangeAccountField_Fax != NULL ) {
        if(ReqChangeAccountField_Fax_len > (Py_ssize_t)sizeof(self->data.Fax)) {
            PyErr_Format(PyExc_ValueError, "Fax too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_Fax_len, (Py_ssize_t)sizeof(self->data.Fax));
            return -1;
        }
        // memset(self->data.Fax, 0, sizeof(self->data.Fax));
        // memcpy(self->data.Fax, ReqChangeAccountField_Fax, ReqChangeAccountField_Fax_len);        
        strncpy(self->data.Fax, ReqChangeAccountField_Fax, sizeof(self->data.Fax) );
        ReqChangeAccountField_Fax = NULL;
    }
            
    ///电子邮件
    // TThostFtdcEMailType char[41]
    if( ReqChangeAccountField_EMail != NULL ) {
        if(ReqChangeAccountField_EMail_len > (Py_ssize_t)sizeof(self->data.EMail)) {
            PyErr_Format(PyExc_ValueError, "EMail too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_EMail_len, (Py_ssize_t)sizeof(self->data.EMail));
            return -1;
        }
        // memset(self->data.EMail, 0, sizeof(self->data.EMail));
        // memcpy(self->data.EMail, ReqChangeAccountField_EMail, ReqChangeAccountField_EMail_len);        
        strncpy(self->data.EMail, ReqChangeAccountField_EMail, sizeof(self->data.EMail) );
        ReqChangeAccountField_EMail = NULL;
    }
            
    ///资金账户状态
    // TThostFtdcMoneyAccountStatusType char
    self->data.MoneyAccountStatus = ReqChangeAccountField_MoneyAccountStatus;
            
    ///银行帐号
    // TThostFtdcBankAccountType char[41]
    if( ReqChangeAccountField_BankAccount != NULL ) {
        if(ReqChangeAccountField_BankAccount_len > (Py_ssize_t)sizeof(self->data.BankAccount)) {
            PyErr_Format(PyExc_ValueError, "BankAccount too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_BankAccount_len, (Py_ssize_t)sizeof(self->data.BankAccount));
            return -1;
        }
        // memset(self->data.BankAccount, 0, sizeof(self->data.BankAccount));
        // memcpy(self->data.BankAccount, ReqChangeAccountField_BankAccount, ReqChangeAccountField_BankAccount_len);        
        strncpy(self->data.BankAccount, ReqChangeAccountField_BankAccount, sizeof(self->data.BankAccount) );
        ReqChangeAccountField_BankAccount = NULL;
    }
            
    ///银行密码
    // TThostFtdcPasswordType char[41]
    if( ReqChangeAccountField_BankPassWord != NULL ) {
        if(ReqChangeAccountField_BankPassWord_len > (Py_ssize_t)sizeof(self->data.BankPassWord)) {
            PyErr_Format(PyExc_ValueError, "BankPassWord too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_BankPassWord_len, (Py_ssize_t)sizeof(self->data.BankPassWord));
            return -1;
        }
        // memset(self->data.BankPassWord, 0, sizeof(self->data.BankPassWord));
        // memcpy(self->data.BankPassWord, ReqChangeAccountField_BankPassWord, ReqChangeAccountField_BankPassWord_len);        
        strncpy(self->data.BankPassWord, ReqChangeAccountField_BankPassWord, sizeof(self->data.BankPassWord) );
        ReqChangeAccountField_BankPassWord = NULL;
    }
            
    ///新银行帐号
    // TThostFtdcBankAccountType char[41]
    if( ReqChangeAccountField_NewBankAccount != NULL ) {
        if(ReqChangeAccountField_NewBankAccount_len > (Py_ssize_t)sizeof(self->data.NewBankAccount)) {
            PyErr_Format(PyExc_ValueError, "NewBankAccount too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_NewBankAccount_len, (Py_ssize_t)sizeof(self->data.NewBankAccount));
            return -1;
        }
        // memset(self->data.NewBankAccount, 0, sizeof(self->data.NewBankAccount));
        // memcpy(self->data.NewBankAccount, ReqChangeAccountField_NewBankAccount, ReqChangeAccountField_NewBankAccount_len);        
        strncpy(self->data.NewBankAccount, ReqChangeAccountField_NewBankAccount, sizeof(self->data.NewBankAccount) );
        ReqChangeAccountField_NewBankAccount = NULL;
    }
            
    ///新银行密码
    // TThostFtdcPasswordType char[41]
    if( ReqChangeAccountField_NewBankPassWord != NULL ) {
        if(ReqChangeAccountField_NewBankPassWord_len > (Py_ssize_t)sizeof(self->data.NewBankPassWord)) {
            PyErr_Format(PyExc_ValueError, "NewBankPassWord too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_NewBankPassWord_len, (Py_ssize_t)sizeof(self->data.NewBankPassWord));
            return -1;
        }
        // memset(self->data.NewBankPassWord, 0, sizeof(self->data.NewBankPassWord));
        // memcpy(self->data.NewBankPassWord, ReqChangeAccountField_NewBankPassWord, ReqChangeAccountField_NewBankPassWord_len);        
        strncpy(self->data.NewBankPassWord, ReqChangeAccountField_NewBankPassWord, sizeof(self->data.NewBankPassWord) );
        ReqChangeAccountField_NewBankPassWord = NULL;
    }
            
    ///投资者帐号
    // TThostFtdcAccountIDType char[13]
    if( ReqChangeAccountField_AccountID != NULL ) {
        if(ReqChangeAccountField_AccountID_len > (Py_ssize_t)sizeof(self->data.AccountID)) {
            PyErr_Format(PyExc_ValueError, "AccountID too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_AccountID_len, (Py_ssize_t)sizeof(self->data.AccountID));
            return -1;
        }
        // memset(self->data.AccountID, 0, sizeof(self->data.AccountID));
        // memcpy(self->data.AccountID, ReqChangeAccountField_AccountID, ReqChangeAccountField_AccountID_len);        
        strncpy(self->data.AccountID, ReqChangeAccountField_AccountID, sizeof(self->data.AccountID) );
        ReqChangeAccountField_AccountID = NULL;
    }
            
    ///期货密码
    // TThostFtdcPasswordType char[41]
    if( ReqChangeAccountField_Password != NULL ) {
        if(ReqChangeAccountField_Password_len > (Py_ssize_t)sizeof(self->data.Password)) {
            PyErr_Format(PyExc_ValueError, "Password too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_Password_len, (Py_ssize_t)sizeof(self->data.Password));
            return -1;
        }
        // memset(self->data.Password, 0, sizeof(self->data.Password));
        // memcpy(self->data.Password, ReqChangeAccountField_Password, ReqChangeAccountField_Password_len);        
        strncpy(self->data.Password, ReqChangeAccountField_Password, sizeof(self->data.Password) );
        ReqChangeAccountField_Password = NULL;
    }
            
    ///银行帐号类型
    // TThostFtdcBankAccTypeType char
    self->data.BankAccType = ReqChangeAccountField_BankAccType;
            
    ///安装编号
    // TThostFtdcInstallIDType int
    self->data.InstallID = ReqChangeAccountField_InstallID;
        
    ///验证客户证件号码标志
    // TThostFtdcYesNoIndicatorType char
    self->data.VerifyCertNoFlag = ReqChangeAccountField_VerifyCertNoFlag;
            
    ///币种代码
    // TThostFtdcCurrencyIDType char[4]
    if( ReqChangeAccountField_CurrencyID != NULL ) {
        if(ReqChangeAccountField_CurrencyID_len > (Py_ssize_t)sizeof(self->data.CurrencyID)) {
            PyErr_Format(PyExc_ValueError, "CurrencyID too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_CurrencyID_len, (Py_ssize_t)sizeof(self->data.CurrencyID));
            return -1;
        }
        // memset(self->data.CurrencyID, 0, sizeof(self->data.CurrencyID));
        // memcpy(self->data.CurrencyID, ReqChangeAccountField_CurrencyID, ReqChangeAccountField_CurrencyID_len);        
        strncpy(self->data.CurrencyID, ReqChangeAccountField_CurrencyID, sizeof(self->data.CurrencyID) );
        ReqChangeAccountField_CurrencyID = NULL;
    }
            
    ///期货公司银行编码
    // TThostFtdcBankCodingForFutureType char[33]
    if( ReqChangeAccountField_BrokerIDByBank != NULL ) {
        if(ReqChangeAccountField_BrokerIDByBank_len > (Py_ssize_t)sizeof(self->data.BrokerIDByBank)) {
            PyErr_Format(PyExc_ValueError, "BrokerIDByBank too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_BrokerIDByBank_len, (Py_ssize_t)sizeof(self->data.BrokerIDByBank));
            return -1;
        }
        // memset(self->data.BrokerIDByBank, 0, sizeof(self->data.BrokerIDByBank));
        // memcpy(self->data.BrokerIDByBank, ReqChangeAccountField_BrokerIDByBank, ReqChangeAccountField_BrokerIDByBank_len);        
        strncpy(self->data.BrokerIDByBank, ReqChangeAccountField_BrokerIDByBank, sizeof(self->data.BrokerIDByBank) );
        ReqChangeAccountField_BrokerIDByBank = NULL;
    }
            
    ///银行密码标志
    // TThostFtdcPwdFlagType char
    self->data.BankPwdFlag = ReqChangeAccountField_BankPwdFlag;
            
    ///期货资金密码核对标志
    // TThostFtdcPwdFlagType char
    self->data.SecuPwdFlag = ReqChangeAccountField_SecuPwdFlag;
            
    ///交易ID
    // TThostFtdcTIDType int
    self->data.TID = ReqChangeAccountField_TID;
        
    ///摘要
    // TThostFtdcDigestType char[36]
    if( ReqChangeAccountField_Digest != NULL ) {
        if(ReqChangeAccountField_Digest_len > (Py_ssize_t)sizeof(self->data.Digest)) {
            PyErr_Format(PyExc_ValueError, "Digest too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_Digest_len, (Py_ssize_t)sizeof(self->data.Digest));
            return -1;
        }
        // memset(self->data.Digest, 0, sizeof(self->data.Digest));
        // memcpy(self->data.Digest, ReqChangeAccountField_Digest, ReqChangeAccountField_Digest_len);        
        strncpy(self->data.Digest, ReqChangeAccountField_Digest, sizeof(self->data.Digest) );
        ReqChangeAccountField_Digest = NULL;
    }
            
    ///长客户姓名
    // TThostFtdcLongIndividualNameType char[161]
    if( ReqChangeAccountField_LongCustomerName != NULL ) {
        if(ReqChangeAccountField_LongCustomerName_len > (Py_ssize_t)sizeof(self->data.LongCustomerName)) {
            PyErr_Format(PyExc_ValueError, "LongCustomerName too long: length=%zd (max allowed is %zd)", ReqChangeAccountField_LongCustomerName_len, (Py_ssize_t)sizeof(self->data.LongCustomerName));
            return -1;
        }
        // memset(self->data.LongCustomerName, 0, sizeof(self->data.LongCustomerName));
        // memcpy(self->data.LongCustomerName, ReqChangeAccountField_LongCustomerName, ReqChangeAccountField_LongCustomerName_len);        
        strncpy(self->data.LongCustomerName, ReqChangeAccountField_LongCustomerName, sizeof(self->data.LongCustomerName) );
        ReqChangeAccountField_LongCustomerName = NULL;
    }
