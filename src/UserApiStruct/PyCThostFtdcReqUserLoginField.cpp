...
static int PyCThostFtdcReqUserLoginField_init(PyCThostFtdcReqUserLoginField *self, PyObject *args, PyObject *kwds) {
    ...
    const char *ReqUserLoginField_SMSCode = NULL;
    Py_ssize_t ReqUserLoginField_SMSCode_len = 0;
            

#if PY_MAJOR_VERSION >= 3
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|y#y#y#y#y#y#y#y#y#y#y#iy#y#", (char **)kwlist
#else
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#s#s#s#s#s#s#s#s#s#is#s#", (char **)kwlist
#endif
        ...
        , &ReqUserLoginField_SMSCode, &ReqUserLoginField_SMSCode_len 
    ...
    ///短信验证码
    // TThostFtdcSMSCodeType char[17]
    if( ReqUserLoginField_SMSCode != NULL ) {
        if(ReqUserLoginField_SMSCode_len >= (Py_ssize_t)sizeof(self->data.SMSCode)) {
            PyErr_Format(PyExc_ValueError, "SMSCode too long: length=%zd (max allowed is %zd)", ReqUserLoginField_SMSCode_len, (Py_ssize_t)sizeof(self->data.SMSCode));
            return -1;
        }
        // memset(self->data.SMSCode, 0, sizeof(self->data.SMSCode));
        // memcpy(self->data.SMSCode, ReqUserLoginField_SMSCode, ReqUserLoginField_SMSCode_len);        
        strncpy(self->data.SMSCode, ReqUserLoginField_SMSCode, sizeof(self->data.SMSCode) );
        ReqUserLoginField_SMSCode = NULL;
    }
...
#if PY_MAJOR_VERSION >= 3
	PyObject *obj = Py_BuildValue("{s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:i,s:y,s:y}"
#else
    PyObject *obj = Py_BuildValue("{s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:i,s:s,s:s}"
#endif
...
///短信验证码
// TThostFtdcSMSCodeType char[17]
static PyObject *PyCThostFtdcReqUserLoginField_get_SMSCode(PyCThostFtdcReqUserLoginField *self, void *closure) {
...
///短信验证码
// TThostFtdcSMSCodeType char[17]
static int PyCThostFtdcReqUserLoginField_set_SMSCode(PyCThostFtdcReqUserLoginField *self, PyObject* val, void *closure) {
    if (!PyBytes_Check(val)) {
...
static PyGetSetDef PyCThostFtdcReqUserLoginField_getset[] = {
    ...
    ///短信验证码 
    {(char *)"SMSCode", (getter)PyCThostFtdcReqUserLoginField_get_SMSCode, (setter)PyCThostFtdcReqUserLoginField_set_SMSCode, (char *)"SMSCode", NULL},
