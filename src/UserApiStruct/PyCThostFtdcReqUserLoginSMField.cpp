...
static int PyCThostFtdcReqUserLoginSMField_init(PyCThostFtdcReqUserLoginSMField *self, PyObject *args, PyObject *kwds) {
    ...
    const char *ReqUserLoginSMField_SMSCode = NULL;
    Py_ssize_t ReqUserLoginSMField_SMSCode_len = 0;
...
#else
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#s#s#s#s#s#s#s#s#s#is#s#s#s#s#s#", (char **)kwlist
#endif
        ...
        , &ReqUserLoginSMField_SMSCode, &ReqUserLoginSMField_SMSCode_len 
    ...
    ///短信验证码
    // TThostFtdcSMSCodeType char[17]
    if( ReqUserLoginSMField_SMSCode != NULL ) {
        if(ReqUserLoginSMField_SMSCode_len > (Py_ssize_t)sizeof(self->data.SMSCode)) {
            PyErr_Format(PyExc_ValueError, "SMSCode too long: length=%zd (max allowed is %zd)", ReqUserLoginSMField_SMSCode_len, (Py_ssize_t)sizeof(self->data.SMSCode));
            return -1;
        }
        // memset(self->data.SMSCode, 0, sizeof(self->data.SMSCode));
        // memcpy(self->data.SMSCode, ReqUserLoginSMField_SMSCode, ReqUserLoginSMField_SMSCode_len);        
        strncpy(self->data.SMSCode, ReqUserLoginSMField_SMSCode, sizeof(self->data.SMSCode) );
        ReqUserLoginSMField_SMSCode = NULL;
    }
...
#if PY_MAJOR_VERSION >= 3
	PyObject *obj = Py_BuildValue("{s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:y,s:i,s:y,s:y,s:y,s:y,s:y,s:y}"
#else
    PyObject *obj = Py_BuildValue("{s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:s,s:i,s:s,s:s,s:s,s:s,s:s,s:s}"
#endif
...
///短信验证码
// TThostFtdcSMSCodeType char[17]
static PyObject *PyCThostFtdcReqUserLoginSMField_get_SMSCode(PyCThostFtdcReqUserLoginSMField *self, void *closure) {
...
///短信验证码
// TThostFtdcSMSCodeType char[17]
static int PyCThostFtdcReqUserLoginSMField_set_SMSCode(PyCThostFtdcReqUserLoginSMField *self, PyObject* val, void *closure) {
    if (!PyBytes_Check(val)) {
...
static PyGetSetDef PyCThostFtdcReqUserLoginSMField_getset[] = {
    ...
    ///短信验证码 
    {(char *)"SMSCode", (getter)PyCThostFtdcReqUserLoginSMField_get_SMSCode, (setter)PyCThostFtdcReqUserLoginSMField_set_SMSCode, (char *)"SMSCode", NULL},
    ///经纪公司名称 
