...
static int PyCThostFtdcSecAgentTradeInfoField_init(PyCThostFtdcSecAgentTradeInfoField *self, PyObject *args, PyObject *kwds) {
	...
	const char *pSecAgentTradeInfoField_BrokerID = NULL;
	Py_ssize_t pSecAgentTradeInfoField_BrokerID_len = 0;

	//TThostFtdcAccountIDType char[13]
	const char *pSecAgentTradeInfoField_BrokerSecAgentID = NULL;
	Py_ssize_t pSecAgentTradeInfoField_BrokerSecAgentID_len = 0;

	//TThostFtdcInvestorIDType char[13]
	const char *pSecAgentTradeInfoField_InvestorID = NULL;
	Py_ssize_t pSecAgentTradeInfoField_InvestorID_len = 0;

	//TThostFtdcLongIndividualNameType char[161]
	const char *pSecAgentTradeInfoField_LongCustomerName = NULL;
	Py_ssize_t pSecAgentTradeInfoField_LongCustomerName_len = 0;
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#s#s#", (char **)kwlist
		...
		, &pSecAgentTradeInfoField_BrokerID, &pSecAgentTradeInfoField_BrokerID_len
		, &pSecAgentTradeInfoField_BrokerSecAgentID, &pSecAgentTradeInfoField_BrokerSecAgentID_len
		, &pSecAgentTradeInfoField_InvestorID, &pSecAgentTradeInfoField_InvestorID_len
		, &pSecAgentTradeInfoField_LongCustomerName, &pSecAgentTradeInfoField_LongCustomerName_len
	...
	//TThostFtdcBrokerIDType char[11]
	if(pSecAgentTradeInfoField_BrokerID != NULL) {
		if(pSecAgentTradeInfoField_BrokerID_len > (Py_ssize_t)sizeof(self->data.BrokerID)) {
			PyErr_Format(PyExc_ValueError, "BrokerID too long: length=%zd (max allowed is %zd)", pSecAgentTradeInfoField_BrokerID_len, (Py_ssize_t)sizeof(self->data.BrokerID));
			return -1;
		}
		strncpy(self->data.BrokerID, pSecAgentTradeInfoField_BrokerID, sizeof(self->data.BrokerID) );
		pSecAgentTradeInfoField_BrokerID = NULL;
	}

	//TThostFtdcAccountIDType char[13]
	if(pSecAgentTradeInfoField_BrokerSecAgentID != NULL) {
		if(pSecAgentTradeInfoField_BrokerSecAgentID_len > (Py_ssize_t)sizeof(self->data.BrokerSecAgentID)) {
			PyErr_Format(PyExc_ValueError, "BrokerSecAgentID too long: length=%zd (max allowed is %zd)", pSecAgentTradeInfoField_BrokerSecAgentID_len, (Py_ssize_t)sizeof(self->data.BrokerSecAgentID));
			return -1;
		}
		strncpy(self->data.BrokerSecAgentID, pSecAgentTradeInfoField_BrokerSecAgentID, sizeof(self->data.BrokerSecAgentID) );
		pSecAgentTradeInfoField_BrokerSecAgentID = NULL;
	}

	//TThostFtdcInvestorIDType char[13]
	if(pSecAgentTradeInfoField_InvestorID != NULL) {
		if(pSecAgentTradeInfoField_InvestorID_len > (Py_ssize_t)sizeof(self->data.InvestorID)) {
			PyErr_Format(PyExc_ValueError, "InvestorID too long: length=%zd (max allowed is %zd)", pSecAgentTradeInfoField_InvestorID_len, (Py_ssize_t)sizeof(self->data.InvestorID));
			return -1;
		}
		strncpy(self->data.InvestorID, pSecAgentTradeInfoField_InvestorID, sizeof(self->data.InvestorID) );
		pSecAgentTradeInfoField_InvestorID = NULL;
	}

	//TThostFtdcLongIndividualNameType char[161]
	if(pSecAgentTradeInfoField_LongCustomerName != NULL) {
		if(pSecAgentTradeInfoField_LongCustomerName_len > (Py_ssize_t)sizeof(self->data.LongCustomerName)) {
			PyErr_Format(PyExc_ValueError, "LongCustomerName too long: length=%zd (max allowed is %zd)", pSecAgentTradeInfoField_LongCustomerName_len, (Py_ssize_t)sizeof(self->data.LongCustomerName));
			return -1;
		}
		strncpy(self->data.LongCustomerName, pSecAgentTradeInfoField_LongCustomerName, sizeof(self->data.LongCustomerName) );
		pSecAgentTradeInfoField_LongCustomerName = NULL;
	}
