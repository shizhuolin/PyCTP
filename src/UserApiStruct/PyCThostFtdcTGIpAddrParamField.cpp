...
static int PyCThostFtdcTGIpAddrParamField_init(PyCThostFtdcTGIpAddrParamField *self, PyObject *args, PyObject *kwds) {
    ...
    ///系统名称
    // TThostFtdcAddrNameType char[65]
    const char *TGIpAddrParamField_SysName = NULL;
    Py_ssize_t TGIpAddrParamField_SysName_len = 0;
            

#if PY_MAJOR_VERSION >= 3
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|y#y#y#iy#cciy#iiy#y#y#y#", (char **)kwlist
#else
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|s#s#s#is#ccis#iis#s#s#s#", (char **)kwlist
#endif
        ...
        , &TGIpAddrParamField_SysName, &TGIpAddrParamField_SysName_len 
    ...
    if( TGIpAddrParamField_SysName != NULL ) {
        ...
        // memcpy(self->data.SysName, TGIpAddrParamField_SysName, TGIpAddrParamField_SysName_len);        
        strncpy(self->data.SysName, TGIpAddrParamField_SysName, sizeof(self->data.SysName) );
        TGIpAddrParamField_SysName = NULL;
    }
...
#if PY_MAJOR_VERSION >= 3
	PyObject *obj = Py_BuildValue("{s:y,s:y,s:y,s:i,s:y,s:c,s:c,s:i,s:y,s:i,s:i,s:y,s:y,s:y,s:y}"
#else
    PyObject *obj = Py_BuildValue("{s:s,s:s,s:s,s:i,s:s,s:c,s:c,s:i,s:s,s:i,s:i,s:s,s:s,s:s,s:s}"
#endif
...
///系统名称
// TThostFtdcAddrNameType char[65]
static PyObject *PyCThostFtdcTGIpAddrParamField_get_SysName(PyCThostFtdcTGIpAddrParamField *self, void *closure) {
...
///系统名称
// TThostFtdcAddrNameType char[65]
static int PyCThostFtdcTGIpAddrParamField_set_SysName(PyCThostFtdcTGIpAddrParamField *self, PyObject* val, void *closure) {
    if (!PyBytes_Check(val)) {
...
static PyGetSetDef PyCThostFtdcTGIpAddrParamField_getset[] = {
    ...
    ///系统名称 
    {(char *)"SysName", (getter)PyCThostFtdcTGIpAddrParamField_get_SysName, (setter)PyCThostFtdcTGIpAddrParamField_set_SysName, (char *)"SysName", NULL},
